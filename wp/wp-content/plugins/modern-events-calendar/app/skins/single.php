...
class MEC_skin_single extends MEC_skins
{
                        ...
                        <article class="mec-related-event-post col-md-3 col-sm-3">
                            ...
                            <div class="mec-related-event-content">
                                ...
                                <h5>
                                    ...
                                    <span class="mec-holding-status mec-holding-status-expired"><?php _e('Expired!', 'mec'); ?></span>
                                    <?php endif; ?>
                                </h5>
                            </div>
                        </article>
    ...
    public function display_next_previous_events($event)
    {
        ...
        {
            echo '<li class="mec-previous-event"><a class="mec-color mec-bg-color-hover mec-border-color" href="'.$this->main->get_event_date_permalink(get_permalink($p['post_id']), date('Y-m-d', $p['tstart'])).'"><i class="mec-fa-long-arrow-left"></i>'. esc_html__('PRV Event', 'mec') .'</a></li>';
        }

        if(is_array($n) and isset($n['post_id']))
        {
            echo '<li class="mec-next-event"><a class="mec-color mec-bg-color-hover mec-border-color" href="'.$this->main->get_event_date_permalink(get_permalink($n['post_id']), date('Y-m-d', $n['tstart'])).'">'. esc_html__('NXT Event', 'mec') .'<i class="mec-fa-long-arrow-right"></i></a></li>';
        }
                            ...
                            <article class="mec-related-event-post">
                                ...
                                <div class="mec-related-content">
                                    ...
                                    <div class="mec-event-footer">
                                        ...
                                        <a class="mec-booking-button" href="<?php echo $this->main->get_event_date_permalink($event, $event->date['start']['date'], false, $event->data->time); ?>"><?php echo (is_array($event->data->tickets) and count($event->data->tickets) and !strpos($soldout, '%%soldout%%')) ? $this->main->m('register_button', __('REGISTER', 'mec')) : $this->main->m('view_detail', __('View Detail', 'mec')) ; ?></a>
