	...
	public function output( $event_id = 0, $atts = array() ){
		...
		if ( !$display_reason ) {
			...
			$html = '<div class="mec-content-notification"><p>'
					.'<span>'. __('This widget is displayed if cancellation reason is set. In order for the widget in this page to be displayed correctly, please set cancellation reason for your last event.', 'mec').'</span>'
					. '<a href="#" target="_blank">' . __('Cancellation Reason', 'mec') . ' </a>'
				.'</p></div>';
		} else {
