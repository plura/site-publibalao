			...
			<div class="mec-field-<?php echo $field['type']; ?> <?php $required ? 'mec-reg-mandatory' : ''; ?> <?php echo $class; ?>" data-field-id="<?php echo $j; ?>">
				...
				switch ( $type ) {
					case 'first_name':
						$field_type     = 'text';
						$field_id       = 'first_name';
						$field['label'] = isset( $field['label'] ) ? $field['label'] : __('First Name','mec');
						$value      = $current_user->first_name;
						break;
					case 'last_name':
						$field_type     = 'text';
						$field_id       = 'last_name';
						$field['label'] = isset( $field['label'] ) ? $field['label'] : __('Last Name','mec');
						$value      = $current_user->last_name;
						break;
					case 'mec_email':
						$field_type     = 'email';
						$field_id       = $type;
						$field['label'] = isset( $field['label'] ) ? $field['label'] : __('Email','mec');
