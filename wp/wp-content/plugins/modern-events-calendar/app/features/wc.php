...
class MEC_feature_wc extends MEC_base
{
    ...
    public function display_key($display_key, $meta)
    {
        ...
        elseif($meta->key == 'mec_other_dates') $display_key = __('Other Dates', 'mec');
    ...
    public function display_value($display_value, $meta)
    {
        ...
        elseif($meta->key == 'mec_other_dates')
        {
            ...
            foreach($dates as $date)
            {
                ...
                $date_values[] = sprintf(__('%s to %s', 'mec'), $start_datetime, $end_datetime);
            }
    ...
    public function validate($data, $errors)
    {
        ...
        foreach($all_items as $event_id => $tickets)
        {
            ...
            {
                $errors->add('validation', sprintf($this->main->m('booking_restriction_message3', __("Maximum allowed number of tickets that you can book is %s.", 'mec')), $limit));
            }
        }
    }
