        ...
        <div class="mec-gateway-options-form">
            ...
            <div class="mec-form-row">
                <div class="mec-col-12">
                    ...
                    <?php else: ?>
                        <a id="mec_gateway_options_form_stripe_connection_button" class="button button-primary" onclick="mec_stripe_connection_checker();" href="https://connect.stripe.com/oauth/authorize?response_type=code&client_id=<?php echo $client_id; ?>&scope=read_write" target="_blank"><?php echo ($strip_account_id ? __('Connect New Account', 'mec') : __('Connect Your Account', 'mec')); ?></a>
...
class MEC_gateway_paypal_express extends MEC_gateway
{
    ...
    public function checkout_form($transaction_id, $params = array())
    {
        ...
        <form id="mec_do_transaction_paypal_express_form<?php echo $transaction_id; ?>" class="mec-click-pay"
            ...
            <input type="hidden" name="custom"
                ...
                <button type="button" onclick="mec_paypal_express_pre_validation('<?php echo $transaction_id; ?>');" class="mec-book-form-next-button"><?php _e('Pay', 'mec'); ?></button>
        </form>
        <?php
    }
    ...
    public function pre_validation()
    {
        ...
        $this->response(array('success' => 1, 'message' => __('Ready to checkout.', 'mec')));
    }
    ...
    public function options_form()
    {
        ...
        ?>">
            ...
            <div class="mec-form-row">
                ...
                <div class="mec-col-9">
                    <textarea id="mec_gateways<?php echo $this->id(); ?>_comment"
                              name="mec[gateways][<?php echo $this->id(); ?>][comment]"><?php echo (isset($this->options['comment']) and trim($this->options['comment'])) ? stripslashes($this->options['comment']) : esc_html__('Bank Transfer Description', 'mec'); ?></textarea>
                    <span class="mec-tooltip">
						<div class="box left">
							<h5 class="title"><?php _e('Comment', 'mec'); ?></h5>
							<div class="content"><p><?php esc_attr_e('HTML allowed.', 'mec'); ?><a
                ...
                jQuery.ajax(
                {
                    ...
                    success: function (data)
                    {
                        ...
                        if(data.success)
                        {
                            ...
                            if(typeof data.data.invoice_link !== "undefined" && data.data.invoice_link != "")
                            {
                                jQuery("#mec_do_transaction_bank_transfer_message<?php echo $transaction_id; ?>").append(' <a class="mec-invoice-download" href="' + data.data.invoice_link + '"><?php echo esc_js(__('Download Invoice', 'mec')); ?></a>');
                            }

                            // Show Downloadable Link
                            if(typeof data.data.dl_file_link !== "undefined" && data.data.dl_file_link != "")
                            {
                                jQuery("#mec_do_transaction_bank_transfer_message<?php echo $transaction_id; ?>").append(' — <a class="mec-dl-file-download" href="' + data.data.dl_file_link + '"><?php echo esc_js(__('Download File', 'mec')); ?></a>');
                            }
