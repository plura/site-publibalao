    ...
    <div class="mec-wizard-content wns-be-group-tab">
        ...
        <div class="mec-steps-panel">
            ...
            <div class="mec-step-wizard-content mec-active-step" data-step="1">
                <!-- <h4><?php _e('Do you want to import dummy events/Shortcodes?', 'mec'); ?></h4>
                <button class="mec-button-import-events mec-wizard-inner-button"><?php _e('Import All Dummy Events', 'mec'); ?><img src="<?php echo plugin_dir_url(__FILE__ ) . '../../../assets/img/popup/popup-next-icon.svg'; ?>" /></button>
                <button class="mec-button-import-shortcodes mec-wizard-inner-button"><?php _e('Import All Dummy Shortcodes', 'mec'); ?><img src="<?php echo plugin_dir_url(__FILE__ ) . '../../../assets/img/popup/popup-next-icon.svg'; ?>" /></button> -->
                ...
                <form id="mec_save_weekdays_form" style="margin-top:-50px">
                    ...
                    <div class="mec-form-row"  id="mec_settings_weekdays">
                        <label class="mec-col-12" for="mec_settings_weekdays"><?php _e('Weekdays', 'mec'); ?></label>
                        <div class="mec-col-6">
                            <div class="mec-box">
                    ...
                    <div class="mec-form-row" id="mec_settings_weekends">
                        <label class="mec-col-12" for="mec_settings_weekends"><?php _e('Weekends', 'mec'); ?></label>
                        <div class="mec-col-6">
                        <div class="mec-box">
            ...
            <div class="mec-step-wizard-content" data-step="2">
                <form id="mec_save_slug_form">
                    <div class="mec-form-row">
                        <label class="mec-col-2" for="mec_settings_archive_title"><?php _e('Archive Page Title', 'mec'); ?></label>
                        <div class="mec-col-4">
                    ...
                    <div class="mec-form-row">
                        <label class="mec-col-2" for="mec_settings_default_skin_archive"><?php _e('Archive Page Skin', 'mec'); ?></label>
                    ...
                    <div class="mec-form-row">
                        <label class="mec-col-2" for="mec_settings_slug"><?php _e('Main Slug', 'mec'); ?></label>
                        <div class="mec-col-4">
                    ...
                    <div class="mec-form-row">
                        <label class="mec-col-2" for="mec_settings_single_event_single_style"><?php _e('Single Event Style', 'mec'); ?></label>
                        <div class="mec-col-4">
                ...
                <form id="mec_save_module_form">
                    <div class="mec-form-row">
                        ...
                        <div id="mec_count_down_container_toggle" class="mec-col-6 <?php if((isset($settings['countdown_status']) and !$settings['countdown_status']) or !isset($settings['countdown_status'])) echo 'mec-util-hidden'; ?>">
                            <div class="mec-form-row">
                                <label class="mec-col-4" for="mec_settings_countdown_list"><?php _e('Countdown Style', 'mec'); ?></label>
                                <div class="mec-col-4">
            ...
            <div class="mec-step-wizard-content" data-step="5">
                <form id="mec_save_booking_form">
                    ...
                    <div id="mec_booking_container_toggle" class="<?php if((isset($settings['booking_status']) and !$settings['booking_status']) or !isset($settings['booking_status'])) echo 'mec-util-hidden'; ?>">
                        <div class="mec-form-row">
                            <label class="mec-col-2" for="mec_settings_booking_date_selection"><?php _e('Date Selection', 'mec'); ?></label>
                            <div class="mec-col-4">
                        ...
                        <div class="mec-form-row">
                            <label class="mec-col-2" for="mec_settings_booking_registration"><?php _e('Registration', 'mec'); ?></label>
                            <div class="mec-col-4">
