                ...
                <div class="mec-container">
                    ...
                    <form id="mec_settings_form">
                        ...
                        <div id="general_option" class="mec-options-fields active">
                            ...
                            <h4 class="mec-form-subtitle"><?php _e('General', 'mec'); ?></h4>
                            ...
                            <div class="mec-form-row">
                                ...
                                <label class="mec-col-3" for="mec_settings_tag_method"><?php _e('Tag Method', 'mec'); ?></label>
                                <div class="mec-col-9">
                                    <select id="mec_settings_tag_method" name="mec[settings][tag_method]">
                                        <option value="post_tag" <?php if(isset($settings['tag_method']) and $settings['tag_method'] == 'post_tag') echo 'selected="selected"'; ?>><?php _e('Post Tags', 'mec'); ?></option>
                                        <option value="mec_tag" <?php if(isset($settings['tag_method']) and $settings['tag_method'] == 'mec_tag') echo 'selected="selected"'; ?>><?php _e('Independent Tags', 'mec'); ?></option>
                                    </select>
                                    <span class="mec-tooltip">
                                        <div class="box left">
                                            <h5 class="title"><?php _e('Tag Method', 'mec'); ?></h5>
                                            <div class="content"><p><?php esc_attr_e("If you select Post Tags then mec would share post tags and event tags but if you select independent tags, mec would use its own tags.", 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/general-options/" target="_blank"><?php _e('Read More', 'mec'); ?></a></p></div>
                                        </div>
                                        <i title="" class="dashicons-before dashicons-editor-help"></i>
                                    </span>
                                </div>
                            ...
                            <div class="mec-form-row" style="padding-bottom: 3px;">
                                <label class="mec-col-3" for="mec_settings_ical_feed"><?php _e('iCal Feed', 'mec'); ?></label>
                                <div class="mec-col-9">
                                    <label id="mec_settings_tag_method" >
                                        <input type="hidden" name="mec[settings][ical_feed]" value="0" />
                                        <input value="1" type="checkbox" name="mec[settings][ical_feed]" <?php if(isset($settings['ical_feed']) and $settings['ical_feed']) echo 'checked="checked"'; ?> /> <?php _e('Enable', 'mec'); ?>
                                    </label>
                                </div>
                            </div>
                            <div class="mec-form-row">
                        ...
                        <div id="email_option" class="mec-options-fields">
                            ...
                            <h4 class="mec-form-subtitle"><?php _e('Email', 'mec'); ?></h4>
                        ...
                        <div id="archive_options" class="mec-options-fields">
                            ...
                            <div class="mec-form-row">
                                <label class="mec-col-3" for="mec_settings_archive_title_tag"><?php _e('Tag of Archive Page Title', 'mec'); ?></label>
                                <div class="mec-col-9">
                        ...
                        <div id="currency_option" class="mec-options-fields">
                            <h4 class="mec-form-subtitle"><?php _e('Currency', 'mec'); ?></h4>
                            <div class="mec-form-row">
                        ...
                        <div id="assets_per_page_option" class="mec-options-fields">
                            <h4 class="mec-form-subtitle"><?php _e('Assets Per Page', 'mec'); ?></h4>
                            <div class="mec-form-row">
                                <label>
                                    <input type="hidden" name="mec[settings][assets_per_page_status]" value="0" />
                                    <input onchange="jQuery('#mec_assets_per_page_container_toggle').toggle();" value="1" type="checkbox" name="mec[settings][assets_per_page_status]" <?php if(isset($settings['assets_per_page_status']) and $settings['assets_per_page_status']) echo 'checked="checked"'; ?> /> <?php _e('Enable Assets Per Page', 'mec'); ?>
                                </label>
                            </div>
                        ...
                        <div id="recaptcha_option" class="mec-options-fields">
                            <h4 class="mec-form-subtitle"><?php _e('Google Recaptcha', 'mec'); ?></h4>
                            <div class="mec-form-row">
                                <label>
                        ...
                        <div id="fes_option" class="mec-options-fields">
                            ...
                            <div class="mec-form-row <?php echo ((!isset($settings['fes_section_organizer']) or (isset($settings['fes_section_organizer']) and $settings['fes_section_organizer'])) ? '' : 'mec-util-hidden'); ?>" id="mec_settings_fes_use_all_organizers_wrapper">
                                <label class="mec-col-3" for="mec_settings_fes_use_all_organizers"><?php _e('Ability to Use All Organizers', 'mec'); ?></label>
                                <div class="mec-col-9">
                                    ...
                                    <span class="mec-tooltip">
                                        <div class="box left">
                                            <h5 class="title"><?php _e('Use All Organizers', 'mec'); ?></h5>
                            ...
                            <div id="mec_fes_booking_section_options" style="margin: 0 0 40px 0; padding: 20px 20px 4px; border: 1px solid #ddd;" class="<?php echo ((!isset($settings['fes_section_booking']) or (isset($settings['fes_section_booking']) and $settings['fes_section_booking'])) ? '' : 'mec-util-hidden'); ?>">
                                ...
                                <div class="mec-form-row">
                                    <label>
                                        ...
                                        <input value="1" type="checkbox" name="mec[settings][fes_section_booking_typ]" <?php if(!isset($settings['fes_section_booking_typ']) or (isset($settings['fes_section_booking_typ']) and $settings['fes_section_booking_typ'])) echo 'checked="checked"'; ?> /> <?php _e('Thank You Page', 'mec'); ?>
                                    </label>
                                </div>
                                <div class="mec-form-row">
                                    <label>
                                ...
                                <label>
                                    ...
                                    <input value="1" type="checkbox" name="mec[settings][booking_private_description]" <?php if(!isset($settings['booking_private_description']) or (isset($settings['booking_private_description']) and $settings['booking_private_description'])) echo 'checked="checked"'; ?> /> <?php _e('Private Description', 'mec'); ?>
                                </label>
                                </div>
                                <div class="mec-form-row">
                                    <label>
                                ...
                                <div class="mec-form-row">
                                    <label>
                                        ...
                                        <input value="1" type="checkbox" name="mec[settings][fes_section_booking_att]" <?php if(!isset($settings['fes_section_booking_att']) or (isset($settings['fes_section_booking_att']) and $settings['fes_section_booking_att'])) echo 'checked="checked"'; ?> /> <?php _e('Attendees', 'mec'); ?>
                                    </label>
                                </div>
                            </div>
                            <?php endif; ?>
                        ...
                        <div id="user_profile_options" class="mec-options-fields">
                            ...
                            <div class="mec-form-row">
                                ...
                                <p><?php echo sprintf(__('Use %s attribute to hide canceled bookings. Like %s', 'mec'), '<code>hide-canceleds="1"</code>', '<code>[MEC_profile hide-canceleds="1"]</code>'); ?></p>
                                <p><?php echo sprintf(__('Use %s attribute to show upcoming bookings. Like %s', 'mec'), '<code>show-upcomings="1"</code>', '<code>[MEC_profile show-upcomings="1"]</code>'); ?></p>
                            </div>
                        </div>
