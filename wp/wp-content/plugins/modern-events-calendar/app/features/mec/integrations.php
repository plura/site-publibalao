                    ...
                    <form id="mec_integrations_form">                 
                        ...
                        <?php if($this->main->getPRO()): ?>
                            ...
                            <div id="mailchimp_option" class="mec-options-fields active">
                                <h4 class="mec-form-subtitle"><?php _e('Mailchimp', 'mec'); ?></h4>
                            ...
                            <div id="campaign_monitor_option" class="mec-options-fields">
                                <h4 class="mec-form-subtitle"><?php _e('Campaign Monitor', 'mec'); ?></h4>
                                <div class="mec-form-row">
                                    <label>
                            ...
                            <div id="mailerlite_option" class="mec-options-fields">
                                <h4 class="mec-form-subtitle"><?php _e('MailerLite', 'mec'); ?></h4>
                                <div class="mec-form-row">
                                    <label>
                            ...
                            <div id="constantcontact_option" class="mec-options-fields">
                                <h4 class="mec-form-subtitle"><?php _e('Constant Contact', 'mec'); ?></h4>
                                <div class="mec-form-row">
                                    <label>
                            ...
                            <div id="active_campaign_option" class="mec-options-fields">
                                <h4 class="mec-form-subtitle"><?php _e('Active Campaign', 'mec'); ?></h4>
                                <div class="mec-form-row">
                                    <label>
                            ...
                            <div id="aweber_option" class="mec-options-fields">
                                <h4 class="mec-form-subtitle"><?php _e('AWeber', 'mec'); ?></h4>
                                <div class="mec-form-row">
                                    <label>
                            ...
                            <div id="mailpoet_option" class="mec-options-fields">
                                <h4 class="mec-form-subtitle"><?php _e('MailPoet', 'mec'); ?></h4>
                                <div class="mec-form-row">
                                    <label>
                            ...
                            <div id="sendfox_option" class="mec-options-fields">
                                <h4 class="mec-form-subtitle"><?php _e('Sendfox', 'mec'); ?></h4>
                                <div class="mec-form-row">
                                    <label>
                            ...
                            <div id="buddy_option" class="mec-options-fields">
                                <h4 class="mec-form-subtitle"><?php _e('BuddyPress', 'mec'); ?></h4>
                                <div class="mec-form-row">
                                    <label>
                            ...
                            <div id="learndash_options" class="mec-options-fields">
                                <h4 class="mec-form-subtitle"><?php _e('LearnDash', 'mec'); ?></h4>
                                <div class="mec-form-row">
                                    <label>
                            ...
                            <div id="pmp_options" class="mec-options-fields">
                                <h4 class="mec-form-subtitle"><?php _e('PaidMembership Pro', 'mec'); ?></h4>
                                <div class="mec-form-row">
                                    <label>
                        ...
                        <div class="mec-options-fields">
                            ...
                            <button style="display: none;" id="mec_integrations_form_button" class="button button-primary mec-button-primary" type="submit"><?php _e('Save Changes', 'mec'); ?></button>
                        </div>
                    </form>
