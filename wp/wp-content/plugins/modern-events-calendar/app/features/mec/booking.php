                    ...
                    <form id="mec_booking_form">
                        ...
                        <div id="booking_option" class="mec-options-fields active">
                            ...
                            <div id="mec_booking_container_toggle" class="<?php if((isset($settings['booking_status']) and !$settings['booking_status']) or !isset($settings['booking_status'])) echo 'mec-util-hidden'; ?>">
                                ...
                                <div class="mec-form-row">
                                    ...
                                    <div class="mec-col-9">
                                        <select id="mec_settings_booking_date_selection" name="mec[settings][booking_date_selection]">
                                            ...
                                            <option value="checkboxes" <?php echo ((isset($settings['booking_date_selection']) and $settings['booking_date_selection'] == 'checkboxes') ? 'selected="selected"' : ''); ?>><?php _e('Checkboxes', 'mec'); ?></option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <h5 class="mec-form-subtitle"><?php _e('Booking Cancellation', 'mec'); ?></h5>
                                <div class="mec-form-row">
                                ...
                                <div class="mec-form-row">
                                    <label class="mec-col-3" for="mec_settings_booking_cancel_page"><?php _e('Cancellation Page', 'mec'); ?></label>
                                    <div class="mec-col-9">
                                        ...
                                        <span class="mec-tooltip">
                                            <div class="box left">
                                                <h5 class="title"><?php _e('Cancellation Page', 'mec'); ?></h5>
                                                <div class="content"><p><?php esc_attr_e("User redirects to this page after booking cancellation. Leave it empty if you want to disable it.", 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/booking/" target="_blank"><?php _e('Read More', 'mec'); ?></a></p></div>
                                            </div>
                                            <i title="" class="dashicons-before dashicons-editor-help"></i>
                                        </span>
                                    </div>
                                ...
                                <div class="mec-form-row">
                                    <label class="mec-col-3" for="mec_settings_booking_cancel_page_time"><?php _e('Cancellation Page Time Interval', 'mec'); ?></label>
                                    <div class="mec-col-9">
                                        ...
                                        <span class="mec-tooltip">
                                            <div class="box left">
                                                <h5 class="title"><?php _e('Cancellation Page Time Interval', 'mec'); ?></h5>
                                                <div class="content"><p><?php esc_attr_e("Waiting time before redirecting to cancellation page. It's in miliseconds so 2000 means 2 seconds.", 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/booking/" target="_blank"><?php _e('Read More', 'mec'); ?></a></p></div>
                                            </div>
                                            <i title="" class="dashicons-before dashicons-editor-help"></i>
                                        </span>
                                    </div>
                                ...
                                <h5 class="mec-form-subtitle"><?php _e('Transaction ID', 'mec'); ?></h5>
                                <div class="mec-form-row">
                                    <label class="mec-col-3" for="mec_settings_booking_tid_generation_method"><?php _e('Generation Method', 'mec'); ?></label>
                                    <div class="mec-col-9">
                                ...
                                <div id="mec_settings_booking_tid_ordered_generation" class="<?php echo (!isset($settings['booking_tid_gen_method']) or (isset($settings['booking_tid_gen_method']) and $settings['booking_tid_gen_method'] == 'random')) ? 'mec-util-hidden' : ''; ?>">
                                    <div class="mec-form-row">
                                        <label class="mec-col-3" for="mec_settings_booking_tid_start_from"><?php _e('Start From', 'mec'); ?></label>
                                        <div class="mec-col-9">
                                ...
                                <h5 class="mec-form-subtitle"><?php _e('Who can book?', 'mec'); ?></h5>
                                <div class="mec-form-row">
                                        ...
                                        <label for="mec_settings_booking_disable_ticket_times">
                                            ...
                                            <input type="checkbox" name="mec[settings][disable_ticket_times]" id="mec_settings_booking_disable_ticket_times"
                                                <?php echo ((isset($settings['disable_ticket_times']) and $settings['disable_ticket_times'] == '1') ? 'checked="checked"' : ''); ?>
                                                   value="1" />
                                            <?php _e('Disable Ticket Times', 'mec'); ?>
                                        </label>
                                    </div>
                                </div>
                        ...
                        <div id="booking_shortcode" class="mec-options-fields">
                            ...
                            <div class="mec-form-row">
                                <div class="mec-col-12">
                                    <p><?php echo sprintf(__("Booking module is available in the event details page but if you like to embed booking module of certain event into a custom WP page or post or any shortcode compatible widgets, all you need to do is to insert %s shortcode into the page content and place the event id instead of 1.", 'mec'), '<code>[mec-booking event-id="1"]</code>'); ?></p>
                        ...
                        <div id="taxes_option" class="mec-options-fields">
                            ...
                            <div id="mec_taxes_fees_container_toggle" class="<?php if((isset($settings['taxes_fees_status']) and !$settings['taxes_fees_status']) or !isset($settings['taxes_fees_status'])) echo 'mec-util-hidden'; ?>">
                                ...
                                <div class="mec-form-row">
                                    <h4><?php echo __('Disable Fees per Gateways', 'mec'); ?></h4>
                            ...
                            <?php else: ?>
                                <div class="mec-form-row">
                                    <label>
                                        ...
                                        <input onchange="jQuery('#mec_ticket_variations_container_toggle').toggle();" value="1" type="checkbox" name="mec[settings][ticket_variations_status]" <?php if(isset($settings['ticket_variations_status']) and $settings['ticket_variations_status']) echo 'checked="checked"'; ?> /> <?php _e('Enable ticket variations module', 'mec'); ?>
                                    </label>
                                </div>
                                        ...
                                        <?php $i = 0; foreach($ticket_variations as $key=>$ticket_variation): if(!is_numeric($key)) continue; $i = max($i, $key); ?>
                                            <div class="mec-box" id="mec_ticket_variation_row<?php echo $i; ?>">
                                                ...
                                                <div class="mec-form-row">
                                                    ...
                                                    <button class="button" type="button" id="mec_remove_ticket_variation_button<?php echo $i; ?>" onclick="mec_remove_ticket_variation(<?php echo $i; ?>, 'ticket_variation');"><?php _e('Remove', 'mec'); ?></button>
                                                </div>
                                            </div>
                                        <?php endforeach; ?>
                                    </div>
                                    ...
                                    <div class="mec-util-hidden" id="mec_new_ticket_variation_raw">
                                        <div class="mec-box" id="mec_ticket_variation_row:i:">
                                            ...
                                            <div class="mec-form-row">
                                                ...
                                                <button class="button" type="button" id="mec_remove_ticket_variation_button:i:" onclick="mec_remove_ticket_variation(:i:, 'ticket_variation');"><?php _e('Remove', 'mec'); ?></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="mec-form-row">
                                    <label>
                                        ...
                                        <input value="1" type="checkbox" name="mec[settings][ticket_variations_per_ticket]" <?php if(isset($settings['ticket_variations_per_ticket']) and $settings['ticket_variations_per_ticket']) echo 'checked="checked"'; ?> /> <?php _e('Enable variations per ticket', 'mec'); ?>
                                    </label>
                                </div>
                            <?php endif; ?>
                        </div>
                        ...
                        <div id="uploadfield_option" class="mec-options-fields">
                            <h4 class="mec-form-subtitle"><?php _e('Upload Field', 'mec'); ?></h4>
                            <div class="mec-form-row">
                                    ...
                                    <div class="mec-form-row">
                                        <div class="mec-col-12">
                                            <label>
                                                ...
                                                <input id="mec_gateways_gateways_per_event" value="1" type="checkbox" name="mec[gateways][gateways_per_event]" <?php if(isset($gateways_options['gateways_per_event']) and $gateways_options['gateways_per_event']) echo 'checked="checked"'; ?> /> <?php _e('Disable / Enable payment gateways per event', 'mec'); ?>
                                            </label>
                                            <span class="mec-tooltip">
                                                <div class="box">
                                    ...
                                    <div class="mec-form-row">
                                        <div class="mec-col-12">
                                            <label>
                                                ...
                                                <input id="mec_gateways_auto_refund" value="1" type="checkbox" name="mec[settings][booking_auto_refund]" <?php if(isset($settings['booking_auto_refund']) and $settings['booking_auto_refund']) echo 'checked="checked"'; ?> /> <?php _e('Automatically refund the payment', 'mec'); ?>
                                            </label>
                                            <span class="mec-tooltip">
                                                <div class="box">
                                                    <h5 class="title"><?php _e('Auto Refund', 'mec'); ?></h5>
                                                    <div class="content"><p><?php esc_attr_e("Automatically refund the payment when a booking paid by applicable gateways (Stripe) got canceled.", 'mec'); ?></p></div>
                                                </div>
                                                <i title="" class="dashicons-before dashicons-editor-help"></i>
                                            </span>
                                        </div>
