...
<div class="mec-calendar-metabox">
    ...
    <div class="mec-form-row mec-switcher">
        ...
        <div class="mec-col-8">
            <label><?php _e('Show Labels', 'mec'); ?></label>
        </div>
        <div class="mec-col-4">
    ...
    <div class="mec-form-row mec-switcher">
        ...
        <div class="mec-col-8">
            <label><?php _e('Show Reset Button', 'mec'); ?></label>
        </div>
        <div class="mec-col-4">
    ...
    <div class="mec-form-row mec-switcher">
        ...
        <div class="mec-col-8">
            <label><?php _e('Refine Search Parameters', 'mec'); ?></label>
        </div>
        <div class="mec-col-4">
            ...
            <div class="mec-search-form-options-container mec-util-hidden" id="mec_list_search_form_options_container">
                ...
                <div class="mec-form-row">
                    ...
                    <select class="mec-col-12" name="mec[sf-options][list][category][type]" id="mec_sf_list_category">
                        ...
                        <option value="checkboxes" <?php if(isset($sf_options_list['category']) and isset($sf_options_list['category']['type']) and $sf_options_list['category']['type'] == 'checkboxes') echo 'selected="selected"'; ?>><?php _e('Multiselect', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
            ...
            <div class="mec-search-form-options-container mec-util-hidden" id="mec_grid_search_form_options_container">
                ...
                <div class="mec-form-row">
                    ...
                    <select class="mec-col-12" name="mec[sf-options][grid][category][type]" id="mec_sf_grid_category">
                        ...
                        <option value="checkboxes" <?php if(isset($sf_options_grid['category']) and isset($sf_options_grid['category']['type']) and $sf_options_grid['category']['type'] == 'checkboxes') echo 'selected="selected"'; ?>><?php _e('Multiselect', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
            ...
            <div class="mec-search-form-options-container mec-util-hidden" id="mec_agenda_search_form_options_container">
                ...
                <div class="mec-form-row">
                    ...
                    <select class="mec-col-12" name="mec[sf-options][agenda][category][type]" id="mec_sf_agenda_category">
                        ...
                        <option value="checkboxes" <?php if(isset($sf_options_agenda['category']) and isset($sf_options_agenda['category']['type']) and $sf_options_agenda['category']['type'] == 'checkboxes') echo 'selected="selected"'; ?>><?php _e('Multiselect', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
            ...
            <div class="mec-search-form-options-container mec-util-hidden" id="mec_full_calendar_search_form_options_container">
                ...
                <div class="mec-form-row">
                    ...
                    <select class="mec-col-12" name="mec[sf-options][full_calendar][category][type]" id="mec_sf_full_calendar_category">
                        ...
                        <option value="checkboxes" <?php if(isset($sf_options_full_calendar['category']) and isset($sf_options_full_calendar['category']['type']) and $sf_options_full_calendar['category']['type'] == 'checkboxes') echo 'selected="selected"'; ?>><?php _e('Multiselect', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
            ...
            <div class="mec-search-form-options-container mec-util-hidden" id="mec_monthly_view_search_form_options_container">
                ...
                <div class="mec-form-row">
                    ...
                    <select class="mec-col-12" name="mec[sf-options][monthly_view][category][type]" id="mec_sf_monthly_view_category">
                        ...
                        <option value="checkboxes" <?php if(isset($sf_options_monthly_view['category']) and isset($sf_options_monthly_view['category']['type']) and $sf_options_monthly_view['category']['type'] == 'checkboxes') echo 'selected="selected"'; ?>><?php _e('Multiselect', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
            ...
            <div class="mec-search-form-options-container mec-util-hidden" id="mec_yearly_view_search_form_options_container">
                ...
                <div class="mec-form-row">
                    ...
                    <select class="mec-col-12" name="mec[sf-options][yearly_view][category][type]" id="mec_sf_yearly_view_category">
                        ...
                        <option value="checkboxes" <?php if(isset($sf_options_yearly_view['category']) and isset($sf_options_yearly_view['category']['type']) and $sf_options_yearly_view['category']['type'] == 'checkboxes') echo 'selected="selected"'; ?>><?php _e('Multiselect', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
            ...
            <div class="mec-search-form-options-container mec-util-hidden" id="mec_map_search_form_options_container">
                ...
                <div class="mec-form-row">
                    ...
                    <select class="mec-col-12" name="mec[sf-options][map][category][type]" id="mec_sf_map_category">
                        ...
                        <option value="checkboxes" <?php if(isset($sf_options_map['category']) and isset($sf_options_map['category']['type']) and $sf_options_map['category']['type'] == 'checkboxes') echo 'selected="selected"'; ?>><?php _e('Multiselect', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
                ...
                <div class="mec-form-row">
                    <label class="mec-col-12" for="mec_sf_map_month_filter"><?php _e('Date Filter', 'mec'); ?></label>
                    <select class="mec-col-12" name="mec[sf-options][map][month_filter][type]" id="mec_sf_map_month_filter">
                        <option value="0" <?php if(isset($sf_options_map['month_filter']) and isset($sf_options_map['month_filter']['type']) and $sf_options_map['month_filter']['type'] == '0') echo 'selected="selected"'; ?>><?php _e('Disabled', 'mec'); ?></option>
                        <option value="dropdown" <?php if(isset($sf_options_map['month_filter']) and isset($sf_options_map['month_filter']['type']) and $sf_options_map['month_filter']['type'] == 'dropdown') echo 'selected="selected"'; ?>><?php _e('Year & Month Dropdown', 'mec'); ?></option>
                        <option value="date-range-picker" <?php if(isset($sf_options_map['month_filter']) and isset($sf_options_map['month_filter']['type']) and $sf_options_map['month_filter']['type'] == 'date-range-picker') echo 'selected="selected"'; ?>><?php _e('Date Picker', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
            ...
            <div class="mec-search-form-options-container mec-util-hidden" id="mec_daily_view_search_form_options_container">
                ...
                <div class="mec-form-row">
                    ...
                    <select class="mec-col-12" name="mec[sf-options][daily_view][category][type]" id="mec_sf_daily_view_category">
                        ...
                        <option value="checkboxes" <?php if(isset($sf_options_daily_view['category']) and isset($sf_options_daily_view['category']['type']) and $sf_options_daily_view['category']['type'] == 'checkboxes') echo 'selected="selected"'; ?>><?php _e('Multiselect', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
            ...
            <div class="mec-search-form-options-container mec-util-hidden" id="mec_weekly_view_search_form_options_container">
                ...
                <div class="mec-form-row">
                    ...
                    <select class="mec-col-12" name="mec[sf-options][weekly_view][category][type]" id="mec_sf_weekly_view_category">
                        ...
                        <option value="checkboxes" <?php if(isset($sf_options_weekly_view['category']) and isset($sf_options_weekly_view['category']['type']) and $sf_options_weekly_view['category']['type'] == 'checkboxes') echo 'selected="selected"'; ?>><?php _e('Multiselect', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
            ...
            <div class="mec-search-form-options-container mec-util-hidden" id="mec_timetable_search_form_options_container">
                ...
                <div class="mec-form-row">
                    ...
                    <select class="mec-col-12" name="mec[sf-options][timetable][category][type]" id="mec_sf_timetable_category">
                        ...
                        <option value="checkboxes" <?php if(isset($sf_options_timetable['category']) and isset($sf_options_timetable['category']['type']) and $sf_options_timetable['category']['type'] == 'checkboxes') echo 'selected="selected"'; ?>><?php _e('Multiselect', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
            ...
            <div class="mec-search-form-options-container mec-util-hidden" id="mec_tile_search_form_options_container">
                ...
                <div class="mec-form-row">
                    ...
                    <select class="mec-col-12" name="mec[sf-options][tile][category][type]" id="mec_sf_tile_category">
                        ...
                        <option value="checkboxes" <?php if(isset($sf_options_tile['category']) and isset($sf_options_tile['category']['type']) and $sf_options_tile['category']['type'] == 'checkboxes') echo 'selected="selected"'; ?>><?php _e('Multiselect', 'mec'); ?></option>
                    </select>
                </div>
                <div class="mec-form-row">
