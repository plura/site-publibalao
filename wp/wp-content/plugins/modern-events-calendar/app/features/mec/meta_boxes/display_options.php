        ...
        <div class="mec-skins-options-container">
            ...
            <div class="mec-skin-options-container mec-util-hidden" id="mec_full_calendar_skin_options_container">
                ...
                <div id="mec_full_calendar_monthly_view_options" <?php echo (isset($sk_options_full_calendar['monthly']) and $sk_options_full_calendar['monthly']) ? '' : 'style="display:none;"'; ?>>
                    <div class="mec-form-row mec-switcher">
                        <div class="mec-col-4">
                            <label for="mec_skin_full_calendar_activate_first_date"><?php _e('Activate First upcoming Date with Event', 'mec'); ?></label>
                        </div>
                        <div class="mec-col-4">
                    ...
                    <div class="mec-form-row mec-switcher">
                        <div class="mec-col-4">
                            <label for="mec_skin_full_calendar_activate_current_day"><?php _e('Activate Current Day in Next / Previous Months', 'mec'); ?></label>
                        </div>
                        <div class="mec-col-4">
                ...
                <div class="mec-form-row mec-switcher mec-include-events-local-times" id="mec_skin_full_calendar_localtime">
                    <div class="mec-col-4">
                        <label for="mec_skin_full_calendar_include_local_time"><?php _e('Include Local Time', 'mec'); ?></label>
                    </div>
                    <div class="mec-col-4">
            ...
            <div class="mec-skin-options-container mec-util-hidden" id="mec_monthly_view_skin_options_container">
                ...
                <div class="mec-form-row mec-switcher mec-not-monthly_view-fluent">
                    <div class="mec-col-4">
                        <label for="mec_skin_monthly_view_activate_first_date"><?php _e('Activate First upcoming Date with Event', 'mec'); ?></label>
                    </div>
                    <div class="mec-col-4">
                ...
                <div class="mec-form-row mec-switcher mec-not-monthly_view-fluent">
                    <div class="mec-col-4">
                        <label for="mec_skin_monthly_view_activate_current_day"><?php _e('Activate Current Day in Next / Previous Months', 'mec'); ?></label>
                    </div>
                    <div class="mec-col-4">
                ...
                <div class="mec-form-row mec-switcher mec-not-monthly_view-fluent">
                    <div class="mec-col-4">
                        <label for="mec_skin_monthly_view_display_all"><?php _e('Display all events in right section', 'mec'); ?></label>
                    </div>
                    <div class="mec-col-4">
            ...
            <div class="mec-skin-options-container mec-util-hidden" id="mec_timetable_skin_options_container">
                ...
                <div class="mec-timetable-modern-style-depended">
                    <div class="mec-form-row">
                        <label class="mec-col-4" for="mec_skin_timetable_number_of_days_modern"><?php _e('Number of Days Per Week', 'mec'); ?></label>
                ...
                <div class="mec-timetable-clean-style-depended mec-timetable-fluent">
                    <div class="mec-form-row">
                        <label class="mec-col-4" for="mec_skin_timetable_number_of_days"><?php _e('Number of Days Per Week', 'mec'); ?></label>
            ...
            <div class="mec-skin-options-container mec-util-hidden" id="mec_carousel_skin_options_container">
                ...
                <div class="mec-form-row">
                    ...
                    <input class="mec-col-4" type="number" min="1000" step="1" name="mec[sk-options][carousel][autoplay]" id="mec_skin_carousel_autoplay" placeholder="<?php _e('eg. 3000 default is 3 second', 'mec'); ?>" value="<?php if(isset($sk_options_carousel['autoplay']) && $sk_options_carousel['autoplay'] != '') echo $sk_options_carousel['autoplay']; ?>" />
                </div>
                <div class="mec-form-row mec-switcher">
                    <div class="mec-col-4">
            ...
            <div class="mec-skin-options-container mec-util-hidden" id="mec_slider_skin_options_container">
                ...
                <div class="mec-form-row">
                    ...
                    <input class="mec-col-4" type="number" min="1000" step="1" name="mec[sk-options][slider][autoplay]" id="mec_skin_slider_autoplay" placeholder="<?php _e('eg. 3000 default is 3 second', 'mec'); ?>" value="<?php if(isset($sk_options_slider['autoplay']) && $sk_options_slider['autoplay'] != '') echo $sk_options_slider['autoplay']; ?>" />
                </div>
                <div class="mec-form-row">
                    <label class="mec-col-4" for="mec_skin_slider_transition_time"><?php _e('Transition Time', 'mec'); ?></label>
                    <input class="mec-col-4" type="number" min="0" step="1" name="mec[sk-options][slider][transition_time]" id="mec_skin_slider_transition_time" placeholder="<?php _e('eg. 1000 is 1 second', 'mec'); ?>" value="<?php echo ((isset($sk_options_slider['transition_time']) && $sk_options_slider['transition_time'] != '') ? $sk_options_slider['transition_time'] : 250); ?>" />
                </div>
                <!-- Start LocalTime -->
                <div class="mec-form-row mec-switcher mec-include-events-local-times">
                    <div class="mec-col-4">
