                ...
                <div class="mec-container">
                    ...
                    <form id="mec_notifications_form">
                               ...
                               <!-- Start Receiver Users -->
                                ...
                                <div class="mec-form-row">
                                    <div class="mec-col-12">
                                        ...
                                        <label for="mec_notifications_booking_notification_send_to_additional_organizers"><?php _e('Send the email to additional organizers', 'mec'); ?></label>
                                    </div>
                                </div>
                                <?php endif; ?>
                                ...
                                <div class="mec-form-row">
                                    <div class="mec-col-12">
                                        ...
                                        <ul>
                                            ...
                                            <li><span>%%book_other_datetimes%%</span>: <?php _e('Other date and times of booking for multiple date booking system', 'mec'); ?></li>
                                            ...
                                            <li><span>%%event_description%%</span>: <?php _e('Event Description', 'mec'); ?></li>
                                            <li><span>%%event_tags%%</span>: <?php _e('Event Tags', 'mec'); ?></li>
                                            <li><span>%%event_labels%%</span>: <?php _e('Event Labels', 'mec'); ?></li>
                                            <li><span>%%event_categories%%</span>: <?php _e('Event Categories', 'mec'); ?></li>
                                            <li><span>%%event_cost%%</span>: <?php _e('Event Cost', 'mec'); ?></li>
                                            ...
                                            <li><span>%%event_start_time%%</span>: <?php _e('Event Start Time', 'mec'); ?></li>
                                            <li><span>%%event_end_time%%</span>: <?php _e('Event End Time', 'mec'); ?></li>
                            ...
                            <div id="mec_notification_booking_rejection_container_toggle" class="<?php if(!isset($notifications['booking_rejection']) or (isset($notifications['booking_rejection']) and isset($notifications['booking_rejection']['status']) and !$notifications['booking_rejection']['status'])) echo 'mec-util-hidden'; ?>">
                                ...
                                <div class="mec-form-row">
                                    <div class="mec-col-12">
                                        ...
                                        <label for="mec_notifications_booking_rejection_send_to_additional_organizers"><?php _e('Send the email to additional organizers', 'mec'); ?></label>
                                    </div>
                                </div>
                                <?php endif; ?>
                            ...
                            <div id="mec_notification_cancellation_notification_container_toggle" class="<?php if((isset($notifications['cancellation_notification']) and !$notifications['cancellation_notification']['status']) or !isset($notifications['cancellation_notification'])) echo 'mec-util-hidden'; ?>">
                                ...
                                <div class="mec-form-row">
                                    <div class="mec-col-12">
                                        ...
                                        <label for="mec_notifications_cancellation_notification_send_to_additional_organizers"><?php _e('Send the email to additional organizers', 'mec'); ?></label>
                                    </div>
                                </div>
                                <?php endif; ?>
                            ...
                            <div id="mec_notification_admin_notification_container_toggle" class="<?php if(isset($notifications['admin_notification']) and isset($notifications['admin_notification']['status']) and !$notifications['admin_notification']['status']) echo 'mec-util-hidden'; ?>">
                                ...
                                <div class="mec-form-row">
                                    <div class="mec-col-12">
                                        ...
                                        <label for="mec_notifications_admin_notification_send_to_additional_organizers"><?php _e('Send the email to additional organizers', 'mec'); ?></label>
                                    </div>
                                </div>
                                <?php endif; ?>
                            ...
                            <div id="mec_notification_event_soldout_container_toggle" class="<?php if(isset($notifications['event_soldout']) and isset($notifications['event_soldout']['status']) and !$notifications['event_soldout']['status']) echo 'mec-util-hidden'; ?>">
                                ...
                                <div class="mec-form-row">
                                    <div class="mec-col-12">
                                        ...
                                        <label for="mec_notifications_event_soldout_send_to_additional_organizers"><?php _e('Send the email to additional organizers', 'mec'); ?></label>
                                    </div>
                                </div>
                                <?php endif; ?>
                            ...
                            <div id="mec_notification_user_event_publishing_container_toggle" class="<?php if((isset($notifications['user_event_publishing']) and !$notifications['user_event_publishing']['status']) or !isset($notifications['user_event_publishing'])) echo 'mec-util-hidden'; ?>">
                                ...
                                <div class="mec-form-row">
                                    <div class="mec-col-12">
                                        <p class="description"><?php _e('You can use the following placeholders', 'mec'); ?></p>
                                        <ul>
                                            <li><span>%%name%%</span>: <?php _e('Event sender name', 'mec'); ?></li>
                                            <li><span>%%event_title%%</span>: <?php _e('Title of event', 'mec'); ?></li>
                                            <li><span>%%event_description%%</span>: <?php _e('Event Description', 'mec'); ?></li>
                                            <li><span>%%event_tags%%</span>: <?php _e('Event Tags', 'mec'); ?></li>
                                            <li><span>%%event_labels%%</span>: <?php _e('Event Labels', 'mec'); ?></li>
                        ...
                        <div id="event_finished" class="mec-options-fields <?php if(isset($this->settings['booking_status']) and $this->settings['booking_status'] == 0) echo 'active'; ?>">
                            ...
                            <h4 class="mec-form-subtitle"><?php _e('Event Finished', 'mec'); ?></h4>
                            <div class="mec-form-row">
                                <div class="mec-col-12">
                                    <label>
                                        <input type="hidden" name="mec[notifications][event_finished][status]" value="0" />
                                        <input onchange="jQuery('#mec_notification_event_finished_container_toggle').toggle();" value="1" type="checkbox" name="mec[notifications][event_finished][status]" <?php if(isset($notifications['event_finished']['status']) and $notifications['event_finished']['status']) echo 'checked="checked"'; ?> /> <?php _e('Enable event finished notification', 'mec'); ?>
                                    </label>
                                    <p class="mec-col-12 description"><?php _e('It sends after an event finish. You can use it to say thank you to the attendees.', 'mec'); ?></p>
                                </div>
                            </div>
                            <div id="mec_notification_event_finished_container_toggle" class="<?php if((isset($notifications['event_finished']) and !$notifications['event_finished']['status']) or !isset($notifications['event_finished'])) echo 'mec-util-hidden'; ?>">
                                ...
                                <div class="mec-form-row">
                                    ...
                                    <p class="mec-col-12 description"><strong><?php _e('Important Note', 'mec'); ?>: </strong><?php echo sprintf(__("Set a cronjob to call %s file once per hour otherwise it won't send the notifications. Please note that you should call this file %s otherwise it may send the notifications multiple times.", 'mec'), '<code>'.$cron.'</code>', '<strong>'.__('only once per hour', 'mec').'</strong>'); ?></p>
                                </div>
                                <div class="mec-form-row">
                                    <div class="mec-col-3">
                                        <label for="mec_notifications_event_finished_subject"><?php _e('Email Subject', 'mec'); ?></label>
                                    </div>
                                    <div class="mec-col-9">
                                ...
                                <div class="mec-form-row">
                                    <div class="mec-col-3">
                                        <label for="mec_notifications_event_finished_receiver_users"><?php _e('Receiver Users', 'mec'); ?></label>
                                    </div>
                                    <div class="mec-col-9">
                                        <?php
                                ...
                                <div class="mec-form-row">
                                    <div class="mec-col-3">
                                        <label for="mec_notifications_event_finished_receiver_roles"><?php _e('Receiver Roles', 'mec'); ?></label>
                                    </div>
                                    <div class="mec-col-9">
                                        <?php
                                ...
                                <div class="mec-form-row">
                                    <div class="mec-col-3">
                                        <label for="mec_notifications_event_finished_recipients"><?php _e('Custom Recipients', 'mec'); ?></label>
                                    </div>
                                    <div class="mec-col-9">
                                ...
                                <div class="mec-form-row">
                                    <div class="mec-col-3">
                                        <label for="mec_notifications_event_finished_hour"><?php _e('Hour', 'mec'); ?></label>
                                    </div>
                                    <div class="mec-col-9">
                                        ...
                                        <span class="mec-tooltip">
                                            <div class="box left">
                                                <h5 class="title"><?php _e('Send After x Hour', 'mec'); ?></h5>
                                                <div class="content"><p><?php esc_attr_e('It specify the interval between event finish and sending the notification in hour.', 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/notifications/" target="_blank"><?php _e('Read More', 'mec'); ?></a></p></div>
                                            </div>
                                            <i title="" class="dashicons-before dashicons-editor-help"></i>
                                        </span>
                                    </div>
                        ...
                        <div id="notification_template" class="mec-options-fields">
                            <h4 class="mec-form-subtitle"><?php _e('Notification Template', 'mec'); ?></h4>
                            <div class="mec-form-row">
                                <div class="mec-col-12">
                                    <label>
                                        <input type="hidden" name="mec[settings][notif_template_disable]" value="0" />
                                        <input value="1" type="checkbox" name="mec[settings][notif_template_disable]" <?php if(isset($settings['notif_template_disable']) and $settings['notif_template_disable']) echo 'checked="checked"'; ?> /> <?php _e('Disable Notification Template of MEC', 'mec'); ?>
                                    </label>
                                </div>
                            </div>
                        </div>
