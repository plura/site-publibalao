                    ...
                    <form id="mec_single_form">
                        ...
                        <div id="event_options" class="mec-options-fields active">
                            ...
                            <div class="mec-form-row">
                                ...
                                <div class="mec-col-9">
                                    <label id="mec_settings_breadcrumbs" >
                                        ...
                                        <input type="checkbox" name="mec[settings][breadcrumbs]" id="mec_settings_breadcrumbs" <?php echo ((isset($settings['breadcrumbs']) and $settings['breadcrumbs']) ? 'checked="checked"' : ''); ?> value="1" onchange="jQuery('#mec_settings_breadcrumb_options').toggle();" /><?php _e('Enable Breadcrumbs.', 'mec'); ?>
                                    </label>
                                    <span class="mec-tooltip">
                                        <div class="box left">
                            ...
                            <div id="mec_settings_breadcrumb_options" class="<?php echo ((isset($settings['breadcrumbs']) and $settings['breadcrumbs']) ? '' : 'mec-util-hidden'); ?>">
                                <div class="mec-form-row">
                                    <label class="mec-col-3" for="mec_settings_breadcrumbs_category"><?php _e('Category in Breadcrumbs', 'mec'); ?></label>
                                    <div class="mec-col-9">
                                        <label>
                                            <input type="hidden" name="mec[settings][breadcrumbs_category]" value="0" />
                                            <input type="checkbox" name="mec[settings][breadcrumbs_category]" id="mec_settings_breadcrumbs_category" <?php echo ((isset($settings['breadcrumbs_category']) and $settings['breadcrumbs_category']) ? 'checked="checked"' : ''); ?> value="1" /><?php _e('Include Category in Breadcrumbs.', 'mec'); ?>
                                        </label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mec-form-row">
                            <label class="mec-col-3" for="mec_settings_location_description"><?php _e('Change Currency Per Event', 'mec'); ?></label>
                                <div class="mec-col-9">
                                    <label for="mec_settings_currency_per_event">
                                        <input type="hidden" name="mec[settings][currency_per_event]" value="0" />
                                        <input type="checkbox" name="mec[settings][currency_per_event]" id="mec_settings_currency_per_event" <?php echo ((isset($settings['currency_per_event']) and $settings['currency_per_event'] == '1') ? 'checked="checked"' : ''); ?> value="1" /><?php _e('Enable Currency Per Event', 'mec'); ?>
                                    </label>
                                </div>
                            </div>
                        ...
                        <div id="countdown_option" class="mec-options-fields">
                            <h4 class="mec-form-subtitle"><?php _e('Countdown', 'mec'); ?></h4>
                            <div class="mec-form-row">
                                <label>
                            ...
                            <div id="mec_count_down_container_toggle" class="<?php if((isset($settings['countdown_status']) and !$settings['countdown_status']) or !isset($settings['countdown_status'])) echo 'mec-util-hidden'; ?>">
                                ...
                                <div class="mec-form-row">
                                    <div class="mec-col-12">
                                        ...
                                        <label for="mec_settings_countdown_disable_for_ongoing_events"><?php _e('Disable for ongoing events', 'mec'); ?></label>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div id="mec_settings_additional_locations_description" class="<?php if((isset($settings['additional_locations']) and !$settings['additional_locations']) or !isset($settings['additional_locations'])) echo 'mec-util-hidden'; ?>">
                                ...
                                <div class="mec-form-row">
                                    <label id="mec_settings_additional_locations_disable_title">
                                        ...
                                        <input type="checkbox" name="mec[settings][additional_locations_disable_title]" id="mec_settings_additional_locations_disable_title" <?php echo ((isset($settings['additional_locations_disable_title']) and $settings['additional_locations_disable_title']) ? 'checked="checked"' : ''); ?> value="1" /><?php _e('Disable Title For Other Locations.', 'mec'); ?>
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="related_events" class="mec-options-fields">
                            ...
                            <div id="mec_related_events_container_toggle" class="<?php if((isset($settings['related_events']) and !$settings['related_events']) or !isset($settings['related_events'])) echo 'mec-util-hidden'; ?>">
                                <div class="mec-form-row" style="margin-top:20px;">
                                    <label style="margin-right:7px;"><?php _e('Select Taxonomies:', 'mec'); ?></label>
                                ...
                                <div class="mec-form-row">
                                    <label class="mec-col-3" for="mec_settings_related_events_limit"><?php _e('Max Events', 'mec'); ?></label>
                                    <div class="mec-col-9">
                                ...
                                <div class="mec-form-row">
                                    <label>
                                        ...
                                        <input value="1" type="checkbox" name="mec[settings][related_events_display_expireds]" <?php if(isset($settings['related_events_display_expireds']) and $settings['related_events_display_expireds']) echo 'checked="checked"'; ?> /> <?php _e('Display Expired Events', 'mec'); ?>
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="shortcode_only_bookers" class="mec-options-fields">
                            <h4 class="mec-form-subtitle"><?php _e('Content only for bookers', 'mec'); ?></h4>
                            <div class="mec-form-row">
                                <div class="mec-col-12">
                                    <p><?php echo sprintf(__('if you need to show a certain content only for booker users, you can enclose your content using %s shortcode. For example you can use %s code to say "Hi" to bookers.', 'mec'), '<code>[mec-only-booked-users]</code>', '<code>[mec-only-booked-users]Hi[/mec-only-booked-users]</code>'); ?></p>
                                </div>
                            </div>
                        </div>
