                    ...
                    <form id="mec_styles_form">
                        <div class="mec-options-fields">
                            ...
                            <div class="mec-form-row">
                                ...
                                <p class="mec-col-12 description"><?php _e("If you're a developer or you have knowledge of CSS codes, you can place your style codes here. These codes will be included in your theme frontend after all styles so they will override MEC default (or theme) styles.", 'mec'); ?></p>
