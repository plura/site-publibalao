...
class MEC_feature_autoemails extends MEC_base
{
    ...
    {
        $singular_label = __('Email', 'mec');
        $plural_label = __('Emails', 'mec');
    ...
    {
        add_meta_box('mec_email_metabox_details', __('Details', 'mec'), array($this, 'meta_box_details'), $this->PT, 'normal', 'high');
    }
