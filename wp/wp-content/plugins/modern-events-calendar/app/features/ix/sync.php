        ...
        <div class="sync-content w-clearfix extra">
            ...
            <form id="mec_ix_sync_form" action="<?php echo $this->main->get_full_url(); ?>" method="POST">
                <div class="mec-form-row mec-syn-schedule">
                    ...
                    <p id="mec_sync_g_import_cron" class="mec-col-12 <?php echo (isset($ix['sync_g_import']) and $ix['sync_g_import'] == '1') ? '' : 'mec-util-hidden'; ?>"><strong><?php _e('Important Note', 'mec'); ?>: </strong><?php echo sprintf(__("Set a cronjob to call %s file by php atleast once per day otherwise it won't import Google Calendar events.", 'mec'), '<code>'.$cron.'</code>'); ?></p>
                </div>
                <div class="mec-form-row mec-syn-schedule">
                    ...
                    <div id="mec_sync_g_export_cron" class="mec-col-12 <?php echo (isset($ix['sync_g_export']) and $ix['sync_g_export'] == '1') ? '' : 'mec-util-hidden'; ?>" style="margin-top: 20px;">
                        ...
                        <div class="mec-col-12">
                            <strong><?php _e('Important Note', 'mec'); ?>: </strong><?php echo sprintf(__("Set a cronjob to call %s file by php atleast once per day otherwise it won't export your website events into Google Calendar.", 'mec'), '<code>'.$cron.'</code>'); ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="mec-form-row mec-syn-schedule">
                    ...
                    <p id="mec_sync_f_import_cron" class="mec-col-12 <?php echo (isset($ix['sync_f_import']) and $ix['sync_f_import'] == '1') ? '' : 'mec-util-hidden'; ?>"><strong><?php _e('Important Note', 'mec'); ?>: </strong><?php echo sprintf(__("Set a cronjob to call %s file by php atleast once per day otherwise it won't import any event from Facebook.", 'mec'), '<code>'.$cron.'</code>'); ?></p>
                </div>
                <?php endif; ?>
                ...
                <div class="mec-form-row mec-syn-schedule">
                    ...
                    <p id="mec_sync_meetup_import_cron" class="mec-col-12 <?php echo (isset($ix['sync_meetup_import']) and $ix['sync_meetup_import'] == '1') ? '' : 'mec-util-hidden'; ?>"><strong><?php _e('Important Note', 'mec'); ?>: </strong><?php echo sprintf(__("Set a cronjob to call %s file by php atleast once per day otherwise it won't import any event from Meetup.", 'mec'), '<code>'.$cron.'</code>'); ?></p>
                </div>
