...
class MEC_feature_occurrences extends MEC_base
{
    ...
    public function get_occurrence_form($occurrence_id)
    {
        ...
        <li id="mec_occurrences_<?php echo $occurrence_id; ?>">
            ...
            <div class="mec-form-row">
                <div class="mec-col-3"><label for="mec_occurrences_<?php echo $occurrence_id; ?>_title"><?php esc_attr_e('Page Title', 'mec'); ?></label></div>
            ...
            <div class="mec-form-row">
                <div class="mec-col-12">
                    <h4><?php echo sprintf(__('Event Main %s', 'mec'), $this->main->m('taxonomy_location', __('Location', 'mec'))); ?></h4>
                    <div class="mec-form-row">
                        <select name="mec[occurrences][<?php echo $occurrence_id; ?>][location_id]" id="mec_occurrences_<?php echo $occurrence_id; ?>_location_id" title="<?php echo esc_attr__($this->main->m('taxonomy_location', __('Location', 'mec')), 'mec'); ?>">
                            <option value="">-----</option>
                        ...
                        <span class="mec-tooltip">
                            <div class="box top">
                                ...
                                <div class="content"><p><?php esc_attr_e('Choose one of saved locations.', 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/location/" target="_blank"><?php _e('Read More', 'mec'); ?></a></p></div>
                            </div>
            ...
            <div class="mec-form-row">
                <div class="mec-col-12">
                    ...
                    <div class="mec-form-row">
                        <select name="mec[occurrences][<?php echo $occurrence_id; ?>][organizer_id]" id="mec_occurrences_<?php echo $occurrence_id; ?>_organizer_id" title="<?php echo esc_attr__($this->main->m('taxonomy_organizer', __('Organizer', 'mec')), 'mec'); ?>">
                            <option value="">-----</option>
            ...
            <div class="mec-form-row">
                <div class="mec-col-12">
                    ...
                    <div id="mec_meta_box_cost_form">
                        <div class="mec-form-row">
                            <input type="<?php echo ($type === 'alphabetic' ? 'text' : 'number'); ?>" <?php echo ($type === 'numeric' ? 'min="0" step="any"' : ''); ?> class="mec-col-3" name="mec[occurrences][<?php echo $occurrence_id; ?>][cost]" id="mec_occurrences_<?php echo $occurrence_id; ?>_cost" value="<?php echo (isset($params['cost']) ? esc_attr($params['cost']) : ''); ?>" title="<?php _e('Cost', 'mec'); ?>" placeholder="<?php _e('Cost', 'mec'); ?>"/>
                        </div>
                    </div>
                </div>
            </div>
            <div class="mec-form-row">
                <div class="mec-col-12">
                    ...
                    <div class="mec-form-row">
                        <label class="mec-col-2" for="mec_occurrences_<?php echo $occurrence_id; ?>_read_more_link"><?php echo $this->main->m('read_more_link', __('Event Link', 'mec')); ?></label>
                        <input class="mec-col-7" type="text" name="mec[occurrences][<?php echo $occurrence_id; ?>][read_more]" id="mec_occurrences_<?php echo $occurrence_id; ?>_read_more_link" value="<?php echo esc_attr($read_more); ?>" placeholder="<?php _e('eg. http://yoursite.com/your-event', 'mec'); ?>"/>
                        <?php do_action('extra_event_link_occurrence', $post->ID, $occurrence_id); ?>
                    </div>
                    <div class="mec-form-row">
                        <label class="mec-col-2" for="mec_occurrences_<?php echo $occurrence_id; ?>_more_info_link"><?php echo $this->main->m('more_info_link', __('More Info', 'mec')); ?></label>
                        <input class="mec-col-3" type="text" name="mec[occurrences][<?php echo $occurrence_id; ?>][more_info]" id="mec_occurrences_<?php echo $occurrence_id; ?>_more_info_link" value="<?php echo esc_attr($more_info); ?>" placeholder="<?php _e('eg. http://yoursite.com/your-event', 'mec'); ?>"/>
                        <input class="mec-col-2" type="text" name="mec[occurrences][<?php echo $occurrence_id; ?>][more_info_title]" id="mec_occurrences_<?php echo $occurrence_id; ?>_more_info_title" value="<?php echo esc_attr($more_info_title); ?>" placeholder="<?php _e('More Information', 'mec'); ?>"/>
