...
class MEC_feature_events extends MEC_base
{
    ...
    public function add_category_fields()
    {
        ...
        <div class="form-field">
            <label for="mec_cat_color"><?php _e('Color', 'mec'); ?></label>
            <input type="text" name="mec_cat_color" id="mec_cat_color" class="mec-color-picker" />
            <p class="description"><?php _e('Optional category color', 'mec'); ?></p>
        </div>
        <?php if($fallback): ?>
        <div class="form-field">
                ...
                <div class="mec-form-row">
                    ...
                    <?php else: ?>
                        <input type="<?php echo ($type === 'alphabetic' ? 'text' : 'number'); ?>" <?php echo ($type === 'numeric' ? 'min="0" step="any"' : ''); ?> class="mec-col-3" name="mec[cost]" id="mec_cost"
                            value="<?php echo esc_attr($cost); ?>" title="<?php _e('Cost', 'mec'); ?>" placeholder="<?php _e('Cost', 'mec'); ?>"/>
                    <?php endif; ?>
                </div>
            </div>
    ...
    ?>
        <div class="mec-add-booking-tabs-wrap">
            <div class="mec-add-booking-tabs-left">
                ...
                <?php endif; ?>
                <a class="mec-add-booking-tabs-link" data-href="mec_meta_box_booking_options_form_attendees" href="#"><?php echo esc_html__('Bookings','mec'); ?></a>
            ...
            <div class="mec-meta-box-fields mec-booking-tab-content mec-tab-active" id="mec_meta_box_booking_options_form_1">
                ...
                <div class="mec-form-row <?php echo (!$bookings_all_occurrences ? 'mec-util-hidden' : ''); ?>" id="mec_bookings_all_occurrences_options">
                    <label class="mec-col-8" for="mec_bookings_all_occurrences_multiple">
                        ...
                        <?php _e('Allow multiple bookings by same email on different dates.', 'mec'); ?>
                    </label>
                </div>
                <?php endif; ?>
                ...
                <div class="mec-form-row">
                    <label class="mec-col-8" for="mec_booking_stop_selling_after_first_occurrence">
                        ...
                        <?php _e('Stop selling tickets after first occurrence.', 'mec'); ?>
                    </label>
                </div>
                <?php endif; ?>
                ...
                <div class="mec-form-row">
                    <h4 class="mec-title"><?php _e('Thank You Page', 'mec'); ?></h4>
                    <div class="mec-form-row">
                    ...
                    <div id="mec_booking_thankyou_page_options" <?php echo ($bookings_thankyou_page_inherit == 1) ? 'style="display: none;"' : ''; ?>>
                        <br>
                        <div class="mec-form-row">
                            <label class="mec-col-3" for="mec_bookings_booking_thankyou_page"><?php _e('Thank You Page', 'mec'); ?></label>
                            <div class="mec-col-9">
                        ...
                        <div class="mec-form-row">
                            <label class="mec-col-3" for="mec_bookings_booking_thankyou_page_time"><?php _e('Thank You Page Time Interval', 'mec'); ?></label>
                            <div class="mec-col-9">
        ...
        <div class="mec-meta-box-fields mec-booking-tab-content" id="mec-tickets">
                    ...
                    foreach($tickets as $key => $ticket)
                    {
                        ...
                        <div class="mec-box" id="mec_ticket_row<?php echo $key; ?>">
                            ...
                            <div id="mec_variations_per_ticket_container">
                                <div class="mec-form-row">
                                    <h4><?php _e('Variations Per Ticket', 'mec'); ?></h4>
                                    <div id="mec_variations_per_ticket_form<?php echo $key; ?>">
                                        <div class="mec-form-row">
                                            <label>
                                                ...
                                                <input onchange="jQuery('#mec_variations_per_ticket_container_toggle<?php echo $key; ?>').toggle();" value="1" type="checkbox" name="mec[tickets][<?php echo $key; ?>][variations_event_inheritance]" <?php echo ($event_inheritance ? 'checked="checked"' : ''); ?>> <?php _e('Inherit from event options', 'mec'); ?>
                                            </label>
                                        </div>
                                        <div id="mec_variations_per_ticket_container_toggle<?php echo $key; ?>" class="<?php echo ($event_inheritance ? 'mec-util-hidden' : ''); ?>">
                                            <div class="mec-form-row">
                                                <button class="button" type="button" id="mec_add_variation_per_ticket_button<?php echo $key; ?>" onclick="add_variation_per_ticket(<?php echo $key; ?>);"><?php _e('Add', 'mec'); ?></button>
                                            </div>
            ...
            <div class="mec-util-hidden" id="mec_new_ticket_raw">
                <div class="mec-box" id="mec_ticket_row:i:">
                    ...
                    <div class="mec-form-row">
                        <div class="mec-col-4">
                            <input type="text" name="mec[tickets][:i:][minimum_ticket]" value="1" placeholder="<?php _e('Minimum Ticket e.g. 3', 'mec'); ?>">
                            <span class="mec-tooltip">
                                <div class="box top">
                                    <h5 class="title"><?php _e('MinimumTicket', 'mec'); ?></h5>
                                    <div class="content">
                            ...
                            <div id="mec_variations_per_ticket_form:i:">
                                <div class="mec-form-row">
                                    <label>
                                        ...
                                        <input onchange="jQuery('#mec_variations_per_ticket_container_toggle:i:').toggle();" value="1" type="checkbox" name="mec[tickets][:i:][variations_event_inheritance]" checked="checked"> <?php _e('Inherit from event options', 'mec'); ?>
                                    </label>
                                </div>
                                <div id="mec_variations_per_ticket_container_toggle:i:" class="mec-util-hidden">
                                    <div class="mec-form-row">
                                        <button class="button" type="button" id="mec_add_variation_per_ticket_button:i:" onclick="add_variation_per_ticket(:i:);"><?php _e('Add', 'mec'); ?></button>
                                    </div>
            ...
            <div id="mec_meta_box_ticket_variations_form">
                <div class="mec-form-row">
                    <label>
                        ...
                        <input onchange="jQuery('#mec_taxes_ticket_variations_container_toggle').toggle();" value="1" type="checkbox" name="mec[ticket_variations_global_inheritance]" <?php echo ($global_inheritance ? 'checked="checked"' : ''); ?>> <?php _e('Inherit from global options', 'mec'); ?>
                    </label>
                </div>
    ...
    public function meta_box_attendees($post)
    {
        ...
        <div class="mec-meta-box-fields mec-booking-tab-content" id="mec_meta_box_booking_options_form_attendees">
            <h4 class="mec-meta-box-header"><?php _e('Attendees', 'mec'); ?></h4>
    ...
    public function add_buttons($which)
    {
        ...
        {
            echo '<a href="'.admin_url('edit.php?post_type='.$this->PT.'&mec-expired=1').'" class="button">'.esc_html__('Expired Events', 'mec').'</a>';
            echo '&nbsp;<a href="'.admin_url('edit.php?post_type='.$this->PT.'&mec-upcoming=1').'" class="button">'.esc_html__('Upcoming Events', 'mec').'</a>';
        }
    }
    ...
    public function csvexcel($export_all = false, $excel = false)
    {
        ...
        $columns = array(
            ...
            __('End Time', 'mec'),
            __('Link', 'mec'),
            $this->main->m('taxonomy_location', __('Location', 'mec')),
            __('Address', 'mec'),
            $this->main->m('taxonomy_organizer', __('Organizer', 'mec')),
            sprintf(__('%s Tel', 'mec'), $this->main->m('taxonomy_organizer', __('Organizer', 'mec'))),
            sprintf(__('%s Email', 'mec'), $this->main->m('taxonomy_organizer', __('Organizer', 'mec'))),
            $this->main->m('event_cost', __('Event Cost', 'mec')),
        ...
        // Speakers
        if(isset($this->settings['speakers_status']) and $this->settings['speakers_status']) $columns[] = __('Speakers', 'mec');
    ...
    public function mec_event_bookings()
    {
        ...
        if(count($bookings))
        {
            $html .= '<div class="w-clearfix">
                <div class="w-col-xs-3 name">
                    <span>'.__('Title', 'mec').'</span>
                </div>
                <div class="w-col-xs-3 email">
                    <span>'.__('Attendees', 'mec').'</span>
                </div>
                <div class="w-col-xs-3 ticket">
                    <span>'.__('Transaction ID', 'mec').'</span>
                </div>
                <div class="w-col-xs-3">
                    <span>'.__('Price', 'mec').'</span>
                </div>
            </div>';
        ...
        {
            $html .= '<p>'.__("No Bookings Found!", 'mec').'</p>';
        }
